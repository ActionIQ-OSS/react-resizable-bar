var Demo = (function() {
  ...
  return React.createClass({
    ...
    render: function() {
      ...
      var handleRender = (
        React.createElement("div", {style: _styles.resizableHandle})
      );
      return (
        React.createElement("div", null, 
          React.createElement(Resizable, {onChange: this.resizableChange, 
                     percent: percent, 
                     maxPercent: 100, 
                     minPercent: 10, 
                     handleChild: handleRender}, 
            React.createElement("div", {style: _styles.resizable(background)}, text)
          )
        )
      );
    }
