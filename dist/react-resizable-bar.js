...
var ReactResizableBar = (function () {
  ...
  var _styles = {
    ...
    container: function container(width) {
      return {
        width: width + '%',
        position: 'relative',
        height: '100%'
    ...
    overlay: function overlay(activelyResizing) {
      return {
        width: '100%',
        height: '100%',
        position: 'fixed',
    ...
    handle: function handle(enabled) {
      return {
        height: '100%',
        width: '20px',
        position: 'absolute',
  ...
  return React.createClass({
    ...
    render: function render() {
      return React.createElement(
        'div',
        { style: _styles.container(this.props.percent) },
        React.createElement(
          'div',
          { ref: 'theDiv', style: _.extend({}, this.props.style, _styles.div) },
          this.props.children
        ),
        React.createElement(
          'div',
          { style: _styles.handle(this.props.enabled),
